...
- **NFC**: 50 test cases covering precomposed, decomposed, multi-mark
  reordering, Hangul algorithmic composition, singleton decompositions
  (OHM SIGN, ANGSTROM SIGN), UAX #15 D115 blocked composition, segment
  boundaries around composition exclusions, and the Tibetan U+0F73 family
